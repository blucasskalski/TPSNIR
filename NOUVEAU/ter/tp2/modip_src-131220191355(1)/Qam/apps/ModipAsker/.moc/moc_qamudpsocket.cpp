...
#include "../../../libs/QamSockets/qamudpsocket.h"
...
void QamUdpSocket::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QamUdpSocket::sockReceived)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QamUdpSocket::sockInfo)) {
                *result = 1;
                return;
            }
        }
...
const QMetaObject QamUdpSocket::staticMetaObject = {
    { &QUdpSocket::staticMetaObject, qt_meta_stringdata_QamUdpSocket.data,
      qt_meta_data_QamUdpSocket,  qt_static_metacall, nullptr, nullptr}
};
