...
#include "../../../libs/QamSockets/qamabstractserver.h"
...
void QamAbstractServer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QamAbstractServer::received)) {
                *result = 1;
                return;
            }
        }
        {
            typedef void (QamAbstractServer::*_t)(const QByteArray & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QamAbstractServer::sent)) {
                *result = 2;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QamAbstractServer::info)) {
                *result = 3;
                return;
            }
        }
...
const QMetaObject QamAbstractServer::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_QamAbstractServer.data,
      qt_meta_data_QamAbstractServer,  qt_static_metacall, nullptr, nullptr}
};
