...
#include "../../../libs/QamSockets/qamtcpclient.h"
...
void QamTcpClient::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QamTcpClient::sockReceived)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QamTcpClient::sockInfo)) {
                *result = 1;
                return;
            }
        }
...
const QMetaObject QamTcpClient::staticMetaObject = {
    { &QTcpSocket::staticMetaObject, qt_meta_stringdata_QamTcpClient.data,
      qt_meta_data_QamTcpClient,  qt_static_metacall, nullptr, nullptr}
};
